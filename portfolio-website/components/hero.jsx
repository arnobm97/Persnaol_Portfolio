    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center md:text-left md:flex md:items-center md:justify-between">
          <div
            className={`md:max-w-2xl transition-all duration-1000 ${
              isVisible
          ...
          >
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <Link
                href="#contact"
                className="px-8 py-3 text-base font-medium rounded-md text-blue-600 bg-blue-50 hover:bg-blue-100 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700 md:py-4 md:text-lg md:px-10"
              >
                Get In Touch
              </Link>
            </div>
          ...
          <div
            className={`mt-10 md:mt-0 transition-all duration-1000 delay-300 ${
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
        <Link href="#about" className="text-gray-500 dark:text-gray-400">
          <svg
