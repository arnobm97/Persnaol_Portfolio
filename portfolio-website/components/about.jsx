        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-blue-300 rounded-lg blur opacity-25"></div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              ...
              and maintainable code. I'm constantly learning and exploring new
