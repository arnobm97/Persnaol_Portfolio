      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              key={project.id}
              className={`overflow-hidden h-full flex flex-col border rounded-lg shadow-sm bg-white dark:bg-gray-800 dark:border-gray-700 transition-all duration-1000 ${
                isVisible
